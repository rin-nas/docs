...
<table>
  ...
  <tr>
    ...
    <td>Проблема критична, что обозначает полную неработоспособность СУБД в промышленной эксплуатации для ИС Заказчика класса «Критически важная (Mission Critical)» или «Бизнес-критичная (Business Critical)». Работы со стороны Заказчика и Исполнителя ведутся в непрерывном режиме 24х7.</td>
  </tr>
  <tr>
    ...
    <td>Проблема критична, что обозначает полную неработоспособность СУБД в промышленной эксплуатации для ИС Заказчика класса «Критически важная (Mission Critical)» или «Бизнес-критичная (Business Critical)». Работы со стороны Заказчика и Исполнителя ведутся в рабочее время в режиме 9х5.</td>
  </tr>
  <tr>

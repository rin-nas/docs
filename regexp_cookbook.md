...
Главная проблема медлительности — [Catastrophic Backtracking](https://www.regular-expressions.info/catastrophic.html). [Пример](https://regex101.com/r/jye7NW/1) такого рег. выражения.

1. Используйте атомарную группировку (?>…) и/или …++. В диалекте JS нет такой встроенной возможности, но можно использовать конструкцию типа `(?=(…))\1`, которая является аналогом.
...
* было читабельным с выделением логических частей

...
1. Инфраструктура должна быть устойчива к ошибкам людей, т.к. люди всегда ошибаются.
1. Технологии становятся всё сложнее для того, чтобы людям жилось проще и комфортнее.
